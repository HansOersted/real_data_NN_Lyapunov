...
UR5_experiment = readtable('robot_data_j3_50rad.csv');

sample_time = 0.002; % 500 Hz

time = UR5_experiment.timestamp;

q_ref = UR5_experiment.target_q_3;
dq_ref = UR5_experiment.target_qd_3;
ddq_ref = UR5_experiment.target_qdd_3;

q = UR5_experiment.actual_q_3;
dq = UR5_experiment.actual_qd_3;
